...
from typing import Dict, Any, Union, TypeVar, Type, Optional, Callable
...
class PCInformedDECI(End2endCausal):
    ...
    def run_train(
        ...
        self.inference_model.prior_A.data = torch.tensor(self.discovery_model._causal_learner.causal_matrix).to(
    ...
    def get_adj_matrix(self, round: bool = True, samples: int = 100, most_likely_graph: bool = False):
        ...
        """
        return self.inference_model.get_adj_matrix(round=round, samples=samples, most_likely_graph=most_likely_graph)
