...
from typing import Dict, Optional, Tuple, Any, Union, TypeVar, Callable, Type

from ...models.model import Model
from ...datasets.variables import Variables
from ...models.imodel import IModelForInterventions, IModelForCausalInference
...
class End2endCausal(Model, IModelForCausalInference, IModelForInterventions):
    ...
    def __init__(
        ...
        variables: Variables,
        save_dir: str,
        discovery_model: IModelForCausalInference,
    ...
    def run_train(
        ...
        discovery_config, inference_config = self._split_configs(train_config_dict)
    ...
    def get_adj_matrix(self, round: bool = True, samples: int = 100, most_likely_graph: bool = False):
        """
        Returns adjacency matrix learned as a numpy array
        """
        return self.discovery_model.get_adj_matrix(round=round, samples=samples)
    ...
    def _split_configs(config_dict: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        ...
        for key, val in config_dict.items():
            ...
            if key_type in ["discovery", "inference"]:
                raise ValueError("Config parsing has been changed. You need to specify discovery and inference "
    ...
    def create(
        ...
        discovery_config, inference_config = cls._split_configs(model_config_dict)
