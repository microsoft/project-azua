...
class TemporalCausalCSVDatasetLoader(CausalCSVDatasetLoader):
    ...
    def split_data_and_load_dataset(  # type:ignore
        ...
        **kwargs,
        ...
        temporal_dataset = self._process_dataset(temporal_dataset, timeseries_column_index)
    ...
    def load_predefined_dataset(
        ...
        temporal_dataset = self._process_dataset(temporal_dataset, column_index)
        return temporal_dataset

    def _process_dataset(self, dataset: TemporalDataset, timeseries_column_index: int) -> TemporalDataset:
        """
        ...
        # Modify the dataset
        dataset._train_data, dataset._train_mask, dataset._train_segmentation = (
            proc_train_data,
            proc_train_mask,
            train_segmentation,
        )
