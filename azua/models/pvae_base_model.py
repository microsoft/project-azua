...
class PVAEBaseModel(TorchModel, IModelForObjective):
    ...
    def impute_processed_batch(
        ...
        **kwargs,
        ...
        imputations = torch.full((sample_count, batch_size, num_features), np.nan, device=self._device)
        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            for idx, (processed_data_batch, processed_obs_mask_batch, processed_target_mask_batch) in enumerate(
                ...
                processed_data_batch = processed_data_batch.to(self._device)
                processed_obs_mask_batch = processed_obs_mask_batch.to(self._device)
                processed_target_mask_batch = processed_target_mask_batch.to(self._device)
    ...
    def _impute_from_vamp_prior(
        ...
        inducing_data, inducing_mask = (
            inducing_data.to(self._device),
            inducing_mask.to(self._device),
        )
