...
from azua.models.transformer_set_encoder import ISAB, MAB, PMA, SAB, SetTransformer, TransformerSetEncoder
...
def test_set_transformer_shape(
    ...
    for name, param in set_transformer.named_parameters():
